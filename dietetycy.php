<?php 
  ...
  require_once 'head.php'; 
    ...
    if(!isset($_SESSION['user']) || $_SESSION['user']['Typ_Uzytkownika'] !== 3)
    {
          ...
          <div class="col-10 ml-auto">
            <div class="row">
              <div class="col-10 offset-1">
                  <h1 class="text-center text-muted py-3">Wszyscy dietetycy </h1>
                <table class="table table-curved bg-dark text-center text-light mx-auto" id="tabela-dietetycy">
                  <thead>
                    <tr class="text-muted">
                      <th>Imię</th>
                      <th>Nazwisko</th>
                  ...
                  <tbody>
                      <?php
                      $sql = "SELECT UzytkownikID, Imie, Nazwisko, Ulica, Miasto, Kod_Pocztowy, Typ_Uzytkownika, DietetykID from uzytkownik where Typ_Uzytkownika=2";
...
function search() {
  ...
  table = document.getElementById("tabela-dietetycy");
...
<script type="text/javascript">
  $('li.nav-item a[href="dietetycy.php"]').removeClass('sidebar-link').addClass('current');
</script>
</body>
</html>
